<template>
  <div>
    <el-form label-width="100px" :model="formData" :rules="rules" ref="formNode" status-icon>
      
      <el-form-item label="联系地址" prop="address" :disabled="!isEditStatus">
        <el-input type="text" v-model.trim="formData.address"></el-input>
      </el-form-item>

      <el-form-item label="办公电话" prop="officeTel" :disabled="!isEditStatus">
        <el-input type="text" v-model.trim="formData.officeTel"></el-input>
      </el-form-item>

      <el-form-item label="联系电话" prop="contactTel" :disabled="!isEditStatus">
        <el-input type="text" v-model.trim="formData.contactTel"></el-input>
      </el-form-item>

      <el-form-item label="邮政编码" prop="postcode" :disabled="!isEditStatus">
        <el-input type="text" v-model.trim="formData.postcode"></el-input>
      </el-form-item>

      <el-form-item label="电子邮箱" prop="email" :disabled="!isEditStatus">
        <el-input type="text" v-model.trim="formData.email"></el-input>
      </el-form-item>

      <el-form-item label="图片" prop="imgUrl">
        <div v-if="isEditStatus">
          <div>
            <img :src="formData.imgUrl" height="100" alt />
          </div>
